...
-- Jefes (IDs se generarán como 1, 2, 3, 4, 5)
...
-- Empleados (IDs se generarán como 6, 7, 8, 9, 10, 11)
INSERT INTO usuarios (nombre_usuario, contraseña, correo, nombre_completo, rol, activo, tipo_usuario) VALUES
...
-- RRHH (IDs se generarán como 12, 13, 14)
INSERT INTO usuarios (nombre_usuario, contraseña, correo, nombre_completo, rol, activo, tipo_usuario) VALUES
...
-- 2. ROLES ESPECÍFICOS (utilizando los IDs generados secuencialmente)
...
INSERT INTO tareas (titulo, descripcion, empleado_id, jefe_id, fecha_creacion, fecha_vencimiento, completada, prioridad, proyecto_id) VALUES
                                                                                                                                          -- Tareas del Sistema de Gestión (Proyecto ID 1, Jefe ID 1)
                                                                                                                                          ('Desarrollar API', 'Implementar endpoints de la API REST', 6, 1, NOW() - INTERVAL '5 days', CURRENT_DATE + INTERVAL '10 days', false, 'MEDIA', 1),
                                                                                                                                          ('Diseñar interfaz', 'Diseñar la interfaz principal del sistema', 7, 1, NOW() - INTERVAL '7 days', CURRENT_DATE + INTERVAL '5 days', false, 'ALTA', 1),
...
INSERT INTO registros_tiempo (usuario_id, tarea_id, proyecto_id, reunion_id, fecha_registro, hora_inicio, hora_fin, horas_trabajadas, comentario) VALUES
                                                                                                                                                      (6, 1, 1, NULL, CURRENT_DATE - INTERVAL '2 days', NOW() - INTERVAL '26 hours', NOW() - INTERVAL '22 hours', 4.0, 'Avance en la implementación de la API'),
                                                                                                                                                      (7, 2, 1, NULL, CURRENT_DATE - INTERVAL '1 day', NOW() - INTERVAL '25 hours', NOW() - INTERVAL '21 hours', 4.0, 'Diseño de la interfaz principal'),
...
INSERT INTO presupuestos (nombre_cliente, proyecto_id, rrhh_id, fecha_creacion, tarifa_hora, horas_estimadas, costo_total, descripcion, estado) VALUES
                                                                                                                                                    ('Cliente Alfa', 1, 12, CURRENT_DATE - INTERVAL '10 days', 75.0, 200.0, 15000.0, 'Presupuesto inicial para Sistema de Gestión', 'APROBADO'),
                                                                                                                                                    ('Cliente Beta', 2, 13, CURRENT_DATE - INTERVAL '5 days', 80.0, 150.0, 12000.0, 'Presupuesto para desarrollo de App Móvil', 'ENVIADO'),
                                                                                                                                                    ('Cliente Gamma', 3, 14, CURRENT_DATE - INTERVAL '2 days', 70.0, 100.0, 7000.0, 'Presupuesto para rediseño de Portal Web', 'BORRADOR');
